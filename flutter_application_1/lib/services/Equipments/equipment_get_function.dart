...
class EquipmentGetService {
  EquipmentGetService._();
  ...
  static Future<List<Map<String, dynamic>>> fetchEquipments() async {
    final uri = _buildUri('/equipments');
    ...
    if (response.statusCode != 200) {
      ...
      final message = decoded is Map<String, dynamic>
          ...
          : null;
      throw Exception(message ?? 'Failed to fetch equipments (status ${response.statusCode})');
    }
